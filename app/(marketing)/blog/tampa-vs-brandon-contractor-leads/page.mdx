...
export const blog = {
  author: { name: "Mica Growth Team", src: "/Micalogo.png" },
  date: "2026-04-02",
...
<div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-6 mb-12">
  ...
  <nav className="space-y-2 text-sm">
    ...
    <p><a href="#why-acai-exists" className="text-neutral-300 hover:text-purple-400 transition">8. Why Mica Growth Exists</a></p>
  </nav>
</div>
...
<h2 id="why-acai-exists">Why Mica Growth Exists</h2>
