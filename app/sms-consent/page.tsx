      ...
      <div className="relative z-20 flex min-h-screen items-center justify-center">
        <article className="mx-auto w-full max-w-4xl rounded-2xl border border-white/10 bg-black/40 p-6 text-white backdrop-blur-md sm:p-8">
          ...
          <section className="space-y-6 text-center">
            ...
            <p className="text-base leading-relaxed text-neutral-200 md:text-lg">
              By providing your phone number or texting <strong className="text-white">START</strong> to <strong className="text-white">(813) 535-4103</strong>, you agree to receive SMS messages from ACAI Enterprises LLC.
            </p>
